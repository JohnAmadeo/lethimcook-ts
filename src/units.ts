...
/**
 * Enumeration of unit types for categorizing units.
 */
 ...
 * These are the standard units that all other units convert to.
 */
 ...
 * For temperature: conversions are handled separately in the converter.
 */
...
/**
 * Unit type mapping.
 * Maps each unit string to its corresponding UnitType.
 */
 ...
 * @param unit - The unit string to classify
 * @returns The UnitType of the given unit
