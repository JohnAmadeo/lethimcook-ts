...
/**
 * Enum representing the types of units supported by the library.
 */
 ...
 * Maps unit types to their base unit used for conversions.
 */
 ...
 * For temperature: this is not used for conversion (custom logic applies).
 */
 ...
 *
 * @param unit - The unit name to get the type of
