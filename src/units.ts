...
/**
 * Enum representing the different types of units supported.
 */
 ...
 * All conversions normalize to these base units.
 */
...
/**
 * Mapping of unit names to their unit types.
 */
 ...
 *
 * @param unit - The unit string to get the type for
 * @returns The UnitType for the given unit
