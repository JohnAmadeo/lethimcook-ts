...
import { convert_natural } from "../src/natural";

describe("TestNaturalLanguagePatterns", () => {
...
describe("TestNaturalLanguageErrors", () => {
  it("test_unparseable_input", () => {
    expect(() => convert_natural("this is gibberish")).toThrow(
      /Could not parse/
    );
  });
